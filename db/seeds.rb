...
# The data can then be loaded with the rails dbseed command (or created alongside the database with db:setup).
#
# Examples:
#
...
100.times {Appearance.create(guest_id:Guest.all.sample.id, episode_id: Episode.all.sample.id, rating: rand(1...5))}
